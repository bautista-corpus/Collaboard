...
var Textarea = (function(){
    ...
    Textarea.prototype.onMouseUp = function(o) {
        let inst = this;
        inst.disable();
    };

    Textarea.prototype.onMouseMove = function(o) {
        let inst = this;
    ...
    Textarea.prototype.onMouseDown = function(o) {
        let inst = this;
        inst.enable();
        ...
        let texta = new fabric.IText('texto',{
            left: origX,
            top: origY,
            stroke: inst.canvas.freeDrawingBrush.color,
            fill: inst.canvas.freeDrawingBrush.color,
        ...
        inst.canvas.add(texta).setActiveObject(texta);
    };

    Textarea.prototype.isEnable = function() {
        return this.isDrawing;
    };
